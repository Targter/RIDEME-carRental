  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full p-3 mb-2 bg-light rounded-md text-sm">
          <p className="font-medium text-[rgba(13,148,136,0.7)]">
            Demo Credentials:
          </p>
          <p className="text-black">Email: two@gmail.com</p>
          <p className="text-black">Password: two@gmail.com</p>
        </div>
